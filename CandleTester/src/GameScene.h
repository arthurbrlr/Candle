...
class GameScene : public Scene {
	...
	public:
		...
		void Load() override 
		{
			...
			Entity child2 = ECS::New("other_children");
			...
			Entity child_of_child = ECS::New("children_of_children");
			...
			Entity master = ECS::New("gameMaster");
